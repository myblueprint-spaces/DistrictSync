...
- The overall day-to-day mechanics (GDE in, CSV out, SFTP zip upload, atomic writes, >20% anomaly warning) are unchanged and still accurate.
- The `districtsync_YYYY-MM-DD.zip` naming and the "zips everything into one upload" behavior are unchanged.
