...
| `sd10myedbc` | Students, CourseInfo, StudentCourses | Students, CourseInfo, StudentCourses | Phase-2 migration (2026-08-31); mbp_core shape with generated `{student number}@sd10.bc.ca` emails. Standard MyEd BC file naming assumed pending real GDE samples. |
