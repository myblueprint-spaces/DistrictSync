...
| `sd38myedbc` | Students, Staff, Family, Classes, Enrollments, CourseInfo, StudentCourses | Students, Staff, Family, Classes, Enrollments, CourseInfo, StudentCourses | Phase-2 migration (2026-08-31); same 8-12 shape as `sd27myedbc`. Standard file naming assumed. |
