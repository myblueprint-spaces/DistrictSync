...
| `sd38myedbc` | Students, CourseInfo, StudentCourses | Students, CourseInfo, StudentCourses | Phase-2 migration (2026-08-31); moved to the mbp_core shape (2026-09-08) — no SpacesEDU rostering entities, student scope widened to grades 7-12, plus cross-enrollment collapse (`home_school_column: "Home School Number"`) since its real export sends one demographic row per school for a cross-enrolled pupil. Standard file naming assumed. |
