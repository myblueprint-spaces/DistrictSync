...
**Integration PR:** `claude/0053-etl-failure-policy` → `main`, **DRAFT PR #146** (https://github.com/myblueprint-spaces/DistrictSync/pull/146) — keep its slice table current. **Next action:** start S3 (spec: plan § "S3 — Reader side").
